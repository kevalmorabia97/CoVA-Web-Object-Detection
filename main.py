...
log_file = '%s/%s logs.txt' % (results_dir, CV_FOLD)
test_acc_imgwise_file = '%s/%s test_acc_imgwise.csv' % (results_dir, CV_FOLD)
test_acc_domainwise_file = '%s/%s test_acc_domainwise.csv' % (results_dir, CV_FOLD)
model_save_file = '%s/%s saved_model.pth' % (results_dir, CV_FOLD)
